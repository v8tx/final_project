        ...
        <section className="slider" id={"slider"}>
          <ul className="slider-carousel" id="slider-carousel">
            <li className="img1">
              ...
              <a href="http://www.vdiazdesigns.com" target="_blank" className="primary-bg cta1">My Work</a><a href={"http://www.vdiazdesigns.com/images/vdiaz_resume.pdf"} className="secondary-sky-blue-bg cta2" target="_blank">Resume</a> 
            </li>
          </ul>
        </section>
